...
if sure is "y":
    try:
        ...
        line = 1
        while not save_name is char_name:
...
if not sure is "y":
    ...
    if sure is "y":
        ...
        time.sleep(2)
        ("They make choices to do well and achieve their goal in the game.")
    time.sleep(2)
    print("Okay.")
    time.sleep(2)
    print("Moving along...")
    ...
    if char_gender is "m":
        ...
        him = "her"
    time.sleep(2)
    print("So, we are gonna roll up " + str(char_name) + " now...")
    stre = int(random.randint(1, 6) + random.randint(1, 6) + 6)
    ...
    time.sleep(2)
    print("Here is " + str(char_name) + "'s stats:")
    time.sleep(2)
    print("Strength: " + str(stre))
    time.sleep(2)
    print("Dexterity: " + str(dex))
    time.sleep(2)
    print("Consitution: " + str(con))
    ...
    if sure is "y":
       time.sleep(2)
       print("Okay. So, in this game, you have to choose different actions that are listed for you. They determine the path and the survival of your character. They also determine if " + str(his) + " goals will be achieved, what goods they get, and more. The choices will be numbered. Also, you can input these things:")
       time.sleep(2)
       ...
       time.sleep(2)
       print("5. The command \"moo/yn <number>, <number>\", to generate a random number between the two numbers inputed.")
       time.sleep(2)
       ...
       time.sleep(2)
       classe = input("Now, will " + str(char_name) + " be a warrior or spellcaster? This will determine if " + str(he) + " will do stuff like using weapons or punching (warrior) or casting spells and using potions (spellcaster) Tell me \"Warrior\" or \"Spellcaster\".")
       time.sleep(2)
       sure = input("You sure? y/n")
       if not sure is "y":
        time.sleep(2)
       ...
       warrior = ["1*Battleaxe", "10", "1*Club", "0.1", "1, 4", "1*Crossbow", "30", "1, 5", "1*Dagger", "2", "1, 4", "1*Dart", "0.05", "1, 4", "1*Flail", "10", "1, 8", "1*Glaive", "20", "1, 10", "1*Greatclub", "0.2", "1, 8", "1*Halberd", "20", "1, 10", "1*Handaxe", "1", "1, 6", "1*Javelin", "0.5", "1, 6", "1*Mace", "5", "1, 6", "2*Maul", "10", "1, 6", "1*Morningstar", "15", "1, 8", "1*Pike", "5", "1, 10", "1*Rapier", "1, 8", "25", "1*Scimitar", "25", "1, 6", "1*Sickle", "1", "Sling", "0.1", "Spear", "1", "Staff", "0.2", "Sword", "12", "Trident", "5", "War Pick", "5", "Warhammer", "15", "Whip", "2"];
       time.sleep(2)
       print("Yay, we have " + str(char_name) + " rolled up!")
       time.sleep(2)
       print("         _______")
       print("         |   ( /")
       print("        |    \|")
       ...
       print("(________(_| /")
       print("(________(_//")
       stats = "Name: " + str(char_name) + "Level " + str(lvl) + " Focus: " + str(classe) + ""
       print("Here is " + str(his) + " stats: " + str(stats))
